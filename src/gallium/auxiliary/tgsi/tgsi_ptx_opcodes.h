...
OPCODE(1, 2, COMP, ADD, 0, "", 0)
OPCODE(1, 2, REPL, DP3, 0, "", 0)
OPCODE(1, 2, REPL, DP4, 0, "", 0)
OPCODE(1, 2, CHAN, DST, 0, "", 0)
OPCODE(1, 2, COMP, MIN, 0, "", 0)
OPCODE(1, 2, COMP, MAX, 0, "", 0)
OPCODE(1, 2, COMP, SLT, 0, "", 0)
OPCODE(1, 2, COMP, SGE, 0, "", 0)
OPCODE(1, 3, COMP, MAD, 0, "", 0)
OPCODE(1, 2, OTHR, TEX_LZ, 0, "", /*.is_tex =*/ 1)
OPCODE(1, 3, COMP, LRP, 0, "", 0)
OPCODE(1, 3, COMP, FMA, 0, "", 0)
OPCODE(1, 1, REPL, SQRT, 0, "", 0)
...
OPCODE(1, 2, COMP, UMAX, 0, "", 0)
OPCODE(1, 2, COMP, UMIN, 0, "", 0)
